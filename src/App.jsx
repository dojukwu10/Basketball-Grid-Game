...
<div className="immaculate-grid">
    ...
    <span className="button-text" style={{ color: '#FFFFFF' }}>{team4}</span>
    </button>
    ...
    <span className="button-text" style={{ color: '#FFFFFF' }}>{team5}</span>
    </button>
    ...
    <span className="button-text" style={{ color: '#FFFFFF' }}>{team6}</span>
    </button>
